...
export const SidebarKas = ({
  ...
  // Handler untuk perubahan langsung dari input (keyboard fisik)
  ...
  // Handler fokus untuk mengaktifkan keyboard virtual
  ...
  // Handler keyboard virtual QWERTY
  ...
  // Handler keyboard virtual Numpad
  ...
  // JANGAN return null sebelum hooks. Sekarang semua hooks sudah dipanggil.
